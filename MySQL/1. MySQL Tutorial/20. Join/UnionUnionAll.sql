...
-- Example 1: Combining full tables
SELECT * FROM headquarters_employees
UNION ALL SELECT * FROM branch_employees;
    
-- Example 1: Combining full tables  different columns type 
-- Error Code: 1222. The used SELECT statements have a different number of columns
SELECT * FROM headquarters_employees,customers
UNION ALL SELECT * FROM branch_employees;
